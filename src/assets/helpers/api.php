...
if (isset($_GET['function'])) {
    ...
    if ($func == 'getCategories') {
        ...
        $url = "http://190.4.56.14/XploreRestApi/delivery/factura?refNumber=".$refNumber;
    ...
    if ($_POST['function'] == 'insertDelivery') {
        ...
        $url = "http://190.4.56.14/" . $environment . "/api/admins/reports/consolidatedOrdersByDriver";
        ...
        $output = curl_exec($handle);
        curl_close($handle);
    } else if ($_POST['function'] == 'getDriverPending') {
        $post = file_get_contents('php://input');
        $array = json_decode($post);

        $handle = curl_init();

        $url = "http://190.4.56.14/" . $environment . "/api/admins/drivers/getAssignedOrders";
        ...
        $output = curl_exec($handle);
        curl_close($handle);
    } else if ($_POST['function'] == 'getBillingReport') {
        $post = file_get_contents('php://input');
        $array = json_decode($post);

        $handle = curl_init();

        $url = "http://190.4.56.14/" . $environment . "/api/admins/reports/billingReport";
        ...
        $output = curl_exec($handle);
        curl_close($handle);
    } else if ($_POST['function'] == 'readExRates') {
        $post = file_get_contents('php://input');
        $array = json_decode($post);

        $handle = curl_init();

        $url = "http://190.4.56.14/" . $environment . "/api/admins/exchangeRates/read";
        ...
        $output = curl_exec($handle);
        curl_close($handle);
    } else if ($_POST['function'] == 'createExRate') {
        $post = file_get_contents('php://input');
        $array = json_decode($post);

        $handle = curl_init();

        $url = "http://190.4.56.14/" . $environment . "/api/admins/exchangeRates/create";
        ...
        $output = curl_exec($handle);
        curl_close($handle);
    } else if ($_POST['function'] == 'updateExRate') {
        $post = file_get_contents('php://input');
        $array = json_decode($post);

        $handle = curl_init();

        $url = "http://190.4.56.14/" . $environment . "/api/admins/exchangeRates/update";
        ...
        $output = curl_exec($handle);
        curl_close($handle);
    } else if ($_POST['function'] == 'getTermsConditions') {
        $post = file_get_contents('php://input');
        $array = json_decode($post);

        $handle = curl_init();

        $url = "http://190.4.56.14/" . $environment . "/api/admins/termsConditions/get";
        ...
        $output = curl_exec($handle);
        curl_close($handle);
    } else if ($_POST['function'] == 'createTermCondition') {
        $post = file_get_contents('php://input');
        $array = json_decode($post);

        $handle = curl_init();

        $url = "http://190.4.56.14/" . $environment . "/api/admins/termsConditions/create";
        ...
        $output = curl_exec($handle);
        curl_close($handle);
    } else if ($_POST['function'] == 'updateTermCondition') {
        $post = file_get_contents('php://input');
        $array = json_decode($post);

        $handle = curl_init();

        $url = "http://190.4.56.14/" . $environment . "/api/admins/termsConditions/update";
        ...
        $output = curl_exec($handle);
        curl_close($handle);
    } else if ($_POST['function'] == 'validateDateTime') {
        $post = file_get_contents('php://input');
        $array = json_decode($post);

        $handle = curl_init();

        $url = "http://190.4.56.14/" . $environment . "/api/shared/deliveries/valDatTime";
        ...
        $output = curl_exec($handle);
        curl_close($handle);
    }else if ($_POST['function'] == 'getActiveDrivers') {
        $post = file_get_contents('php://input');
        $array = json_decode($post);

        $handle = curl_init();

        $url = "http://190.4.56.14/" . $environment . "/api/admins/drivers/getActive";
        ...
        $output = curl_exec($handle);
        curl_close($handle);
    } else if ($_POST['function'] == 'updateOrder') {
        $post = file_get_contents('php://input');
        $array = json_decode($post);

        $handle = curl_init();

        $url = "http://190.4.56.14/" . $environment . "/api/admins/orders/update";
        ...
        $output = curl_exec($handle);
        curl_close($handle);
    } else if ($_POST['function'] == 'deletePayment') {
        $post = file_get_contents('php://input');
        $array = json_decode($post);

        $handle = curl_init();

        $url = "http://190.4.56.14/" . $environment . "/api/admins/payments/delete";
        ...
        $output = curl_exec($handle);
        curl_close($handle);
    } else if ($_POST['function'] == 'updatePayment') {
        $post = file_get_contents('php://input');
        $array = json_decode($post);

        $handle = curl_init();

        $url = "http://190.4.56.14/" . $environment . "/api/admins/payments/update";
