...
import { CustomerNewBranchComponent } from './new-address/customer-new-branch.component';
...
export class CustomerBranchOfficesComponent implements OnInit {
  ...
  loadData() {
    this.openLoader();
    const branchesSubscription = this.branchService
      .getBranchOffices()
      .subscribe((response) => {
  ...
  showConfirmDelete(id) {
    ...
    this.confMsg =
      '¿Estás seguro de eliminar la dirección ' + currBranch.nomSucursal + '?';
