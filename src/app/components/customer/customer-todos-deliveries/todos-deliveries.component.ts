...
export class TodosDeliveriesComponent implements OnInit {
  ...
  loadData(){
    ...
    if (this.initDate == true) {
      ...
      const serviceSubscription = this.deliveriesService.getFilteredDeliveries(this.consultForm.value).subscribe(response => {
  ...
  onConsultFormSubmit() {
    if (this.consultForm.valid) {
      this.router.navigate(['/customers/reservas-todos', this.consultForm.get('initDate').value,
