...
export class XploreAddCustomerComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.nCustomerForm = this.formBuilder.group({
      nomEmpresa: ['', [Validators.required, Validators.maxLength(80)]],
      ...
      montoGracia: [100, [Validators.required, Validators.minLength(1)]],
      idFrecuenciaFact: [null],
      rtn: ['', [Validators.maxLength(14), Validators.minLength(14)]],
      razonSocial: ['', [Validators.maxLength(80)]],
      email: [
        '',
        [
          Validators.required,
      ...
      correosFact: ['', [Validators.maxLength(200)]],
      enviarNotificaciones: [true, Validators.required],
      pagoTarjeta: [true, Validators.required],
    });
  }
  ...
  onFormSubmit() {
    if (this.nCustomerForm.valid) {
      ...
      const usersSubscription = this.usersService
        .addCustomer(this.nCustomerForm.value)
        .subscribe(
          (response) => {
