...
export class EditCustomerDialogComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.edCustForm = this.formBuilder.group({
      ...
      nomEmpresa: [
        this.currCustomer.nomEmpresa,
        [Validators.required, Validators.maxLength(80)],
      ],
      nomRepresentante: [
        this.currCustomer.nomRepresentante,
        [Validators.required, Validators.maxLength(80)],
      ],
      numIdentificacion: [
        this.currCustomer.numIdentificacion,
        [
          Validators.required,
      ...
      numTelefono: [
        this.currCustomer.numTelefono,
        [Validators.required, Validators.minLength(9), Validators.maxLength(9)],
      ],
      montoGracia: [
        this.currCustomer.montoGracia,
        [Validators.required, Validators.minLength(1)],
      ],
      idFrecuenciaFact: [this.currCustomer.idFrecuenciaFact],
      rtn: [
        this.currCustomer.rtn,
        [Validators.maxLength(14), Validators.minLength(14)],
      ],
      razonSocial: [this.currCustomer.razonSocial, [Validators.maxLength(80)]],
      email: [
        this.currCustomer.email,
        [
          Validators.required,
      ...
      correosFact: [this.currCustomer.correosFact, [Validators.maxLength(200)]],
  ...
  loadData() {
    const bfSubs = this.billingFrecuenciesService
  ...
  onEditFormSubmit() {
    if (this.edCustForm.valid) {
      ...
      this.usersService.editCustomer(this.edCustForm.value).subscribe(
        (response) => {
